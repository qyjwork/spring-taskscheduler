package cn.imacoder.taskscheduler.task.service.jobhandler;
...
public class SampleJob {
     ...
     */
    @XxlJob("sampleJob")
    public ReturnT<String> sampleJob(String param) throws Exception {
        XxlJobLogger.log("sampleJob, Hello World.");
        for (int i = 0; i < 5; i++) {
